...
-(UIView *)lineView{
    if (_lineView == nil) {
        self.lineView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, DEVICE_Width, 0.5)];
...
- (UIButton *)leftBtn{
    if (_leftBtn == nil) {
        ...
        [_leftBtn setImage:[UIImage imageNamed:@"ppt_add_address_normal"] forState:UIControlStateNormal];
...
- (UIButton *)rightBtn{
    if (_rightBtn == nil) {
        ...
        _rightBtn.frame =CGRectMake(DEVICE_Width - 100, 5, 90, 40);
...
-(UILabel *)totalLable{
    if (_totalLable == nil) {
        self.totalLable = [[UILabel alloc] initWithFrame:CGRectMake(DEVICE_Width/2 - 70, 15, DEVICE_Width/2 - 50, 20)];
