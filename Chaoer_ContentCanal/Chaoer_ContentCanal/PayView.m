...
//    }
    ...
    self.mshopname.text =  _shopname;
    self.mmoney.text = [NSString stringWithFormat:@"¥%.2f",_mPayMoney];
...
//    SOrder* temporder = SOrder.new;
//    temporder.mTotalFee = _mPayMoney;
//    [temporder payIt:payType block:^(SResBase *retobj) {
//        
//        if( retobj.msuccess )
//        {
